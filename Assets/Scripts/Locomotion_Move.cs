...
public class Locomotion_Move : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        player.position = player.position + (transform.right * joystickAxis.x + transform.forward * joystickAxis.y) * Time.deltaTime * speed;
