...
namespace FreeDraw
{
    ...
    [RequireComponent(typeof(BoxCollider))]  // REQUIRES A COLLIDER2D to function
    ...
    public class Drawable : MonoBehaviour
    {
        ...
        public Transform SavedImageLoc;
...
//////////////////////////////////////////////////////////////////////////////
        ...
        {
            ApplyMarkedPixelChanges();
            GameObject SavedImage = Instantiate(this.gameObject, SavedImageLoc.transform.position, Quaternion.identity);
        }
    }
}